...
GamePlayManager = {
    ...
    preload: function() {
        ...
        game.load.spritesheet('horse', 'assets/images/personajepeq.png', 84, 156, 2);
        game.load.spritesheet('diamonds', 'assets/images/basuras.png', 81, 84, 4);
    ...
    create: function() {
        ...
        for(var i=0; i<AMOUNT_BOOBLES; i++){
            ...
            var yBooble = game.rnd.integerInRange(300, 950);
        ...
        this.mollusk = game.add.sprite(500, 450, 'mollusk');
        this.shark = game.add.sprite(500,550,'shark');
        ...
        for(var i=0; i<AMOUNT_DIAMONDS; i++){
            ...
            diamond.y = game.rnd.integerInRange(150, 600);
        ...
        this.timerGameOver = game.time.events.loop(Phaser.Timer.SECOND, function(){
            if(this.flagFirstMouseDown){
                ...
                if(this.totalTime<=0){
                    ...
                    this.endGame = true;
                    this.showFinalMessage('Perdiste!! Se ha contaminado el mar');
                }
            }
        },this);
    ...
    increaseScore:function(){
        ...
        if(this.amountDiamondsCaught >= AMOUNT_DIAMONDS){
            game.time.events.remove(this.timerGameOver);
            this.endGame = true;
            this.showFinalMessage('Ganaste!!! Contribuiste en el desarrollo sostenible!!');
        }
    },
